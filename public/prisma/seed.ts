...
async function main() {
  ...
  // Create zones for Yuva Pank (15 seats)
  const yuvaPankhZones = [
    ...
    },
    {
      code: 'BHUJ_ANJAR',
      name: 'Bhuj & Anjar',
      nameGujarati: 'ભુજ અને અંજાર',
      description: 'Bhuj, Mirzapar, Madhapar (taluka - Bhuj), Anjar, Mundra, Adipur, Mandvi, Gandhidham, Shinoim Bhadreshwar, Khedoi',
      seats: 2,
      electionType: 'YUVA_PANK'
    },
    {
      ...
      description: 'Ahmedabad, Valsad, Surat, Vadodara, Ankleshwar, Sachin, Anand, Mehsana, Bharuch, Dahegam, Kapadvanj, Jamnagar, Morbi, Rajkot',
      seats: 3,
      electionType: 'YUVA_PANK'
    }
  ]
